         ...
         #   if text == 'Angry':
          #      randomfile = random.choice(os.listdir("C:/Users/kusha/PycharmProjects/Music_player_with_Emotions_recognition/songs/Angry/"))
           #     print('You are angry !!!! please calm down:) ,I will play song for you :' + randomfile)
            ...
            if text == 'Smile':
                ...
                new=2
                #happy
                url="https://open.spotify.com/playlist/2G9xiJzpmtlYoIIVr6k05j?si=O5twxkP-St62AIFdRAdRjQ"
          ...
          #      subprocess.call([mp, file])
            ...
            if text == 'Sad':
                ...
                new=2
                #sad
                url="https://open.spotify.com/playlist/7Lax5pRxzB5RKDD5iWCVVp?si=pl0X9rrfRByg3TUpiSvNmw"
                webbrowser.open(url,new=new)
            break
